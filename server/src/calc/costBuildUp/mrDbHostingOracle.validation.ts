...
const ASSET_PRODUCT = 'ORACLE DATABASE HOSTING';
const PRODUCT = 'Oracle Database Hosting';

export function runMrDbHostingOracleValidation(): SheetValidation {
  const fixture = loadFixture('mrDbHostingOracle.json');

...
const ASSET_PRODUCT = 'DISK VARIABLE';
const PRODUCT = 'Disk Variable';

export function runMrVirtualServerDiskVariableValidation(): SheetValidation {
  const fixture = loadFixture('mrVirtualServerDiskVariable.json');

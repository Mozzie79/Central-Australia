...
const ASSET_PRODUCT = 'REDHAT OS';
const PRODUCT = 'RedHat OS';

export function runMrVirtualServerRedhatOsValidation(): SheetValidation {
  const fixture = loadFixture('mrVirtualServerRedhatOs.json');

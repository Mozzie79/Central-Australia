...
const ASSET_PRODUCT = 'APP MANAGEMENT';
const PRODUCT = 'App Management';

export function runMrAppManagementValidation(): SheetValidation {
  const fixture = loadFixture('mrAppManagement.json');

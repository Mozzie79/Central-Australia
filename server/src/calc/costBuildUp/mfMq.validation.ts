...
// Confirmed via direct workbook inspection: every row on the MF MQ sheet is explicitly
// $0 for 2026-27 (and has been for several preceding fiscal years too), not missing data
// - the product is decommissioned/inactive for the forecast year.
const ASSET_PRODUCT = 'MFMQ';
const PRODUCT = 'MFMQ';

export function runMfMqValidation(): SheetValidation {
  const fixture = loadFixture('mfMq.json');

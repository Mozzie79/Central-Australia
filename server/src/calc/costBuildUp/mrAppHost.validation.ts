...
// The sheet is named "MR App Host" but the block's own label (and the destination key
// used by EMPLOYEE_ALLOCATIONS/CONTRACTOR_ALLOCATIONS/sharedServiceOverheads) is
// "Application Hosting".
const ASSET_PRODUCT = 'APPLICATION HOSTING';
const PRODUCT = 'Application Hosting';

export function runMrAppHostValidation(): SheetValidation {
  const fixture = loadFixture('mrAppHost.json');

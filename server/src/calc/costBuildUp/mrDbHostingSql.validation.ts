...
const ASSET_PRODUCT = 'SQL DATABASE HOSTING';
const PRODUCT = 'SQL Database Hosting';

export function runMrDbHostingSqlValidation(): SheetValidation {
  const fixture = loadFixture('mrDbHostingSql.json');

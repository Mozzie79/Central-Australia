...
const ASSET_PRODUCT = 'AZURE SERVICES';
const PRODUCT = 'Azure Services';

export function runMrAzureServicesValidation(): SheetValidation {
  const fixture = loadFixture('mrAzureServices.json');

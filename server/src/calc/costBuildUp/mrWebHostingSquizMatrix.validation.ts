...
const ASSET_PRODUCT = 'SQUIZ MATRIX';
const PRODUCT = 'Squiz Matrix';

export function runMrWebHostingSquizMatrixValidation(): SheetValidation {
  const fixture = loadFixture('mrWebHostingSquizMatrix.json');

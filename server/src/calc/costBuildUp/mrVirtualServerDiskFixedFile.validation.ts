...
const PRODUCT = 'Disk Fixed File';

export function runMrVirtualServerDiskFixedFileValidation(): SheetValidation {
  const fixture = loadFixture('mrVirtualServerDiskFixedFile.json');

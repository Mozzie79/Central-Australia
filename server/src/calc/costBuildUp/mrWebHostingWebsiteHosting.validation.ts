...
const ASSET_PRODUCT = 'WEBSITE HOSTING SERVICES';
const PRODUCT = 'Website Hosting Services';

export function runMrWebHostingWebsiteHostingValidation(): SheetValidation {
  const fixture = loadFixture('mrWebHostingWebsiteHosting.json');

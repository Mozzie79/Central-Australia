...
const ASSET_PRODUCT = 'DOMINO / LOTUS NOTES';
const PRODUCT = 'Domino / Lotus Notes';

export function runMrDbHostingNotesValidation(): SheetValidation {
  const fixture = loadFixture('mrDbHostingNotes.json');

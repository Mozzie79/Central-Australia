...
const ASSET_PRODUCT = 'SAN STORAGE';
const PRODUCT = 'SAN Storage';

export function runEsStorageSanStorageValidation(): SheetValidation {
  const fixture = loadFixture('esStorageSanStorage.json');

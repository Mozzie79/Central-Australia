...
const ASSET_PRODUCT = 'APPLICATION SERVICES';
const PRODUCT = 'Application Services';

export function runAppServicesValidation(): SheetValidation {
  const fixture = loadFixture('appServices.json');

...
const ASSET_PRODUCT = 'SHAREPOINT';
const PRODUCT = 'Sharepoint';

export function runMrWebHostingSharepointValidation(): SheetValidation {
  const fixture = loadFixture('mrWebHostingSharepoint.json');

...
const ASSET_PRODUCT = 'BACKUP STORAGE';
const PRODUCT = 'Backup Storage';

export function runEsBackupsBackupStorageValidation(): SheetValidation {
  const fixture = loadFixture('esBackupsBackupStorage.json');

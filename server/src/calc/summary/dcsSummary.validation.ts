...
export const PRODUCT_CONFIGS: Record<string, ProductCostConfig> = {
...
export function runDcsSummaryValidations(): SheetValidation[] {
  ...
  return Object.entries(PRODUCT_CONFIGS).map(([fixtureProduct, config]) => {
    ...
    return { sheetName: `${fixture.sheetName} (${fixtureProduct})`, results };
  });
}
